...
function watching:config/sighting_chance/3_rare

# start delay 10 days
function watching:config/start_delay/add
function watching:config/start_delay/add
function watching:config/start_delay/add
function watching:config/start_delay/add
function watching:config/start_delay/add
...
function watching:config/ghost_door/false
function watching:config/ghost_mine/false

function watching:config/disappearing_torches/false

function watching:config/jumpscare/false

function watching:config/no_sleep/false
function watching:config/dreadful_donation/false
function watching:config/crimson_curse/false

function watching:config/chilled_candles/false

function watching:config/sinister_signs/false

function watching:config/shrine_suprise/true